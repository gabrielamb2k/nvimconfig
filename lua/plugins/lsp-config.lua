return {
  ...
  -- mason lsp config utilizes mason to automatically ensure lsp servers you want installed are installed
  {
    ...
    config = function()
      -- ensure that we have lua language server, typescript language server, and go language server are installed
      -- JDTLS será configurado separadamente via nvim-jdtls
      require("mason-lspconfig").setup({
        ensure_installed = { "lua_ls", "jdtls", "ts_ls", "cssls", "gopls" },
      })
    end,
  },
  ...
  },
  {
    ...
    config = function()
      ...
      -- JDTLS é configurado separadamente via ftplugin/java.lua
